...
export default function Home() {
  return (
    <div className="flex flex-col gap-16">
        ...
        <div className="container relative">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              Transform your future with our industry-leading training programs.
              Get certified, get placed, and get ahead in your career.
            </p>
        ...
        <div className="mx-auto mt-16 max-w-7xl">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((feature) => (
              <div
                key={feature.name}
                className="relative rounded-lg border bg-card p-8 shadow-sm transition-colors hover:bg-accent"
              >
      ...
      {/* CTA Section */}
      <section className="container py-20">
        <div className="relative overflow-hidden rounded-lg bg-primary px-6 py-16 sm:px-12 sm:py-24">
