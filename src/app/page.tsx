...
export const metadata: Metadata = {
  title: 'Launch Verse Academy | Top Web Development, Graphic Design & MS Office Training in Hooghly',
  description: 'Advance your career with Launch Verse Academy, Hooghly\'s premier institute offering expert-led courses in Web Development, Graphic Design, and MS Office. Enroll now for hands-on training and placement support.',
  keywords: [
    // Primary Keywords
